...
./keyvalue-store -leader -leaderPort=$LEADER_PORT -leaderHeartbeatInterval=$HEARTBEAT_INTERVAL -leaderHeartbeatTimeout=$HEARTBEAT_TIMEOUT &
LEADER_PID=$!
...
./keyvalue-store -follower -followerPort=$FOLLOWER_PORT_1 -leaderURL=$LEADER_URL &
FOLLOWER_PID_1=$!
...
./keyvalue-store -follower -followerPort=$FOLLOWER_PORT_2 -leaderURL=$LEADER_URL &
FOLLOWER_PID_2=$!
